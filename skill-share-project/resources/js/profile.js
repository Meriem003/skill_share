                    ...
                    <div class="modal-body">
                        <form id="edit-profile-form">
                            <div class="form-group">
                                ...
                                <input type="text" id="edit-name" value="Marie Dupont" required>
                            </div>
                            <div class="form-group">
                                <label for="edit-campus">Campus</label>
                                <select id="edit-campus" required>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="edit-bio">Je suis une étudiante passionnée par le design et la programmation.</textarea>
                            </div>
                            <div class="form-group">
                                <label>Compétences à enseigner</label>
                                <div class="skills-grid">
                                    <div class="skill-checkbox">
                                        <input type="checkbox" id="edit-teach-js" checked>
                                        <label for="edit-teach-js">JavaScript</label>
                                    </div>
                                    <div class="skill-checkbox">
                                        <input type="checkbox" id="edit-teach-design" checked>
                                        <label for="edit-teach-design">Design UI/UX</label>
                                    </div>
                                    <div class="skill-checkbox">
                                        <input type="checkbox" id="edit-teach-photo" checked>
                                        <label for="edit-teach-photo">Photographie</label>
                                    </div>
                                    <div class="skill-checkbox">
                                        <input type="checkbox" id="edit-teach-english" checked>
                                        <label for="edit-teach-english">Anglais</label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="skills-grid">
                                    <div class="skill-checkbox">
                                        <input type="checkbox" id="edit-learn-python" checked>
                                        <label for="edit-learn-python">Python</label>
                                    </div>
                                    <div class="skill-checkbox">
                                        <input type="checkbox" id="edit-learn-marketing" checked>
                                        <label for="edit-learn-marketing">Marketing digital</label>
                                    </div>
                                    <div class="skill-checkbox">
                                        <input type="checkbox" id="edit-learn-spanish" checked>
                                        <label for="edit-learn-spanish">Espagnol</label>
                                    </div>
                                </div>
                            </div>

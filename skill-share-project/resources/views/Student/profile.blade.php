            ...
            <div class="profile-content">
                ...
                <div class="tab-content active" id="skills-tab">
                    ...
                    <div class="availability-section">
                        ...
                        <button class="btn btn-secondary" id="edit-availability-btn">Modifier mes disponibilités</button>
                    </div>
                </div>
                    ...
                    <div class="sessions-list">
                        <div class="session-card upcoming">
                            <div class="session-header">
                                <span class="session-type teaching">J'enseigne</span>
                                <span class="session-date">Demain, 14:00 - 15:30</span>
                            </div>
                            <div class="session-content">
                                ...
                                <p class="session-location">Bibliothèque du campus</p>
                            </div>
                        ...
                        <div class="session-card upcoming">
                            <div class="session-header">
                                <span class="session-type learning">J'apprends</span>
                                <span class="session-date">Vendredi, 10:00 - 11:00</span>
                            </div>
                            <div class="session-content">
                                ...
                                <p class="session-location">Salle informatique B12</p>
                            </div>
                            <div class="session-actions">
                                <button class="btn btn-secondary btn-sm">Annuler</button>
                                <button class="btn btn-primary btn-sm">Détails</button>
                        ...
                        <div class="session-card past">
                            <div class="session-header">
                                <span class="session-type teaching">J'ai enseigné</span>
                                <span class="session-date">12 mai 2023, 15:00 - 16:30</span>
                            </div>
                            <div class="session-content">
                                ...
                                <p class="session-location">Salle de design</p>
                            </div>
                            <div class="session-actions">
                                <button class="btn btn-primary btn-sm">Voir l'évaluation</button>
                            </div>
                        </div>
                    </div>
                </div>

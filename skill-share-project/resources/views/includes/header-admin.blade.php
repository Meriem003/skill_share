...
<header class="header">
    <div class="container">
        <div class="header-content">
            ...
            <nav class="main-nav">
                <ul class="nav-list">
                    <li class="nav-item"><a href="{{ route('admin.Session') }}" class="nav-link">Sessions</a></li>
                    <li class="nav-item"><a href="{{ route('admin.utilisateurs') }}" class="nav-link">utilisateurs</a></li>
                    <li class="nav-item"><a href="{{ route('admin.Commentaire') }}" class="nav-link">Commentaire</a></li>
                </ul>
            </nav>
                ...
                <div class="user-menu">
                    ...
                    <div class="user-dropdown">
                        <ul class="dropdown-menu">
                            <li><a href="{{ route('home') }}"><i class="fas fa-user"></i> Accueil</a></li>
                            <li><a href="{{ route('admin.dashboard') }}"><i class="fas fa-chart-line"></i> Tableau de bord</a></li>
                            <li class="divider"></li>
                            <li>
